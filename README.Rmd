...
This package is primarily designed for use by `R` package developers. If you are developing a package which contains `R6` classes, you can save yourself extra work defining S3 methods leveraging `R6methods`. `R6methods` is meant to be a lightweight addition for increasing `R6` generic support.
...
These dot-dunder methods must be public methods, and your class must also inherit the `R6` class (i.e. `R6::R6Class(class = TRUE)`, the default). Here is a toy example that adds support to an `R6` class `Foo` for `+`, `-`, and `<` operations.
...
R6methods <- 
  ...
  "Arithmetic" ,".__add__(e2)", "`+`", "",
  "Arithmetic" ,".__sub__(e2)", "`-`", "",
  "Arithmetic" ,".__mul__(e2)", "`*`", "",
  "Arithmetic" ,".__div__(e2)", "`/`", "",
  "Arithmetic" ,".__pow__(e2)", "`^`", "",
  "Arithmetic" ,".__mod__(e2)", "`%%`", "",
  "Arithmetic" ,".__intdiv__(e2)", "`%/%`", "",
  
  "Subsetting" ,".__subset__(i, j, ...)", "`[`", "",
  "Subsetting" ,".__subset2__(i, j, ...)", "`[[`", "",
  "Subsetting" ,".__subsetrep__(..., value)", "`[<-`", "",
  "Subsetting" ,".__subset2rep__(..., value)", "`[[<-`", "",
  
  "Relational" ,".__lt__(e2)", "`<`", "",
  "Relational" ,".__gt__(e2)", "`>`", "",
  "Relational" ,".__le__(e2)", "`<=`", "",
  "Relational" ,".__ge__(e2)", "`>=`", "",
  "Relational" ,".__eq__(e2)", "`==`", "",
  "Relational" ,".__ne__(e2)", "`!=`", "",
  "Relational" ,".__ae__(e2)", "`all.equal`", "",
  
  "Misc", ".__data__(...)", "as.data.frame", "",
  "Misc", ".__length__()", "length", "",
  "Misc", ".__names()__", "names", "",
  "Misc", ".__str(...)__", "str", ""
)
...
If your `R6` instance is iterable, you can call `R6methods::iter(myR6class)` to turn your class into a `coro` iterator. The returned object is a `generator`. The object created by calling this function is an iterator that will iterate the `length()` of your `R6` instance, producing batches of data according to the `.__getitem__()` method.
